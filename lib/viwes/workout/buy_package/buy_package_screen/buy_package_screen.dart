...
import 'package:gym_cheloper/viwes/workout/buy_package/buy_package_controller/buy_package_controller.dart';
...
class _BuyPackageScreenState extends State<BuyPackageScreen> {
  ...
  final controller = Get.put(BuyPackageController());
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: CustomButtonCommon(title: "START 5 DAY FREE TRAIL", onpress: (){context.push(RouteNames.subscriptionbuyScreen);},color: Colors.black,),
                  ),
                  SizedBox(height: 20.h,),
