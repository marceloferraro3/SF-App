...
class QuesstionScreen4 extends StatefulWidget {
  const QuesstionScreen4({super.key});

  @override
  State<QuesstionScreen4> createState() => _QuesstionScreen4State();
}

class _QuesstionScreen4State extends State<QuesstionScreen4> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: SvgPicture.asset(AppIcons.qIcon4),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            CustomTextButton(
              onTap: () {
                context.pushNamed(RouteNames.questionFinalScreen);
              },
              text: "Continue",
            ),
          ],
