...
class RoutePages {
  static List<GetPage<dynamic>>? routes = [
    ...
    // GetPage(name: RouteNames.profileInformation, page: () => ProfileInformation()),
    // GetPage(name: RouteNames.profileInfoUpdate, page: () => ProfileUpdate()),
    // GetPage(name: RouteNames.settingScreen, page: () =>const SettingScreen()),
    // GetPage(name: RouteNames.notificationScreen, page: () => NotificationScreen()),
    //
    //
    ...
    // GetPage(name: RouteNames.privacyPolicyScreen, page: () => PrivacyPolicyScreen()),
    // GetPage(name: RouteNames.termsScreen, page: () => TermsScreen()),
    // GetPage(name: RouteNames.aboutScreen, page: () => AboutScreen()),
    //
    //
